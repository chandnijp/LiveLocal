...
//3) If they are logged in then find the review and if foundReview.author.id.equals(req.user._id) (note.. cannot do === as one is an object and they other is a string) then we move onto next which is whatever code that follows inside the route handler(code)
